...
class Ui_ao_OR(QDialog):
    def setupUi(self, Ui_ao_OR):
        Ui_ao_OR.setObjectName("Ui_ao_OR")
        Ui_ao_OR.resize(1234, 924)
        self.Img1 = QtWidgets.QLabel(Ui_ao_OR)
        self.Img1.setGeometry(QtCore.QRect(10, 80, 601, 411))
        self.Img1.setFrameShape(QtWidgets.QFrame.Box)
        self.Img1.setText("")
        self.Img1.setObjectName("Img1")
        self.Img2 = QtWidgets.QLabel(Ui_ao_OR)
        ...
        self.LbOuput = QtWidgets.QLabel(Ui_ao_OR)
        ...
        self.btn_open = QtWidgets.QPushButton(Ui_ao_OR)
        self.btn_open.setGeometry(QtCore.QRect(210, 20, 251, 41))
        self.btn_open.setObjectName("btn_open")
        self.btn_open.clicked.connect(self.openImage)
        self.btn_progress = QtWidgets.QPushButton(Ui_ao_OR)
        self.btn_progress.setGeometry(QtCore.QRect(490, 20, 251, 41))
        self.btn_progress.setObjectName("btn_progress")
        self.btn_progress.clicked.connect(self.prosesOR)
        self.btn_save = QtWidgets.QPushButton(Ui_ao_OR)
        self.btn_save.setGeometry(QtCore.QRect(770, 20, 251, 41))
        self.btn_save.setObjectName("btn_save")
        self.btn_save.clicked.connect(self.saveImage)

        self.retranslateUi(Ui_ao_OR)
        QtCore.QMetaObject.connectSlotsByName(Ui_ao_OR)

    def retranslateUi(self, Ui_ao_OR):
        _translate = QtCore.QCoreApplication.translate
        Ui_ao_OR.setWindowTitle(_translate("Ui_ao_OR", "Form"))
        self.btn_open.setText(_translate("Ui_ao_OR", "Open"))
        self.btn_progress.setText(_translate("Ui_ao_OR", "Progress"))
        self.btn_save.setText(_translate("Ui_ao_OR", "Save"))
